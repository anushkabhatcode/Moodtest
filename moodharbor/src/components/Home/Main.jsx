...
function Main(){
  ...
  // fetch quotes
  useEffect(() => {
    fetch('https://moodtest-4.onrender.com/quotes')
      ...
      .then(data => {
        ...
        sessionStorage.setItem('quote', data[randomIndex].quotes, 'author', data[randomIndex].author);
  ...
  useEffect(() => {
    ...
    const LogCurrentMood = async (event) => {
      ...
      if (selectedEmoji !== null) {
        try {
          ...
          const response = await fetch('https://moodtest-4.onrender.com/logmood/currentmood', {
            method: 'POST',
            headers: {
    ...
    const LogDesiredMood = async (event) => {
      ...
      if (selectedDesiredEmoji !== null) {
        try {
          ...
          const response = await fetch('https://moodtest-4.onrender.com/logmood/desiredmood', {
            method: 'POST',
            headers: {
              'Content-Type': 'application/json',
              'Authorization': `Bearer ${token}` // Include the JWT token in the Authorization header
    ...
    const LogUserActivity = async (event) => {
      ...
      if (selectedActivityEmoji !== null) {
        try {
          ...
          const response = await fetch('https://moodtest-4.onrender.com/activities', {
            method: 'POST',
            headers: {
              'Content-Type': 'application/json',
              'Authorization': `Bearer ${token}` // Include the JWT token in the Authorization header
    ...
    return(
      <div className="All_Content">
        ...
        {/* <div className="Nomood">
            {!showMessage() && <p className="MoodCaption">Welcome,Shinchan,you have not saved any moods yet. Go ahead and explore.</p>}
          </div> 
        <div className="main">  
                  
          {showMessage() && (
            // <div className="MoodTrendContainer">
            <div className="DesiredTrendContainer">
              <p className="UserTrendCaption">Mood Trends</p>
          ...
          {/* {showMessage() && (
            <div className="DesiredTrendContainer">
              <p className="DesiredTrendCaption">Desired Mood Trends</p>
                <div className="DesiredTrend">
